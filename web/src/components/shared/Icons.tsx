...
export type IconType = "People" | "Camera" | "SquaresPlus" | "CodeBracketSquare" | "Language"

export const getIcon = (icon: IconType) => {
  return icon === "People" ? peopleIcon
    : icon === "Camera" ? cameraIcon
      : icon === "SquaresPlus" ? squaresPlus
        : icon === "CodeBracketSquare" ? codeBracketSquare
